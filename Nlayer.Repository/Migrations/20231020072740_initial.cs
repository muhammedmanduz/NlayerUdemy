    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 20, 10, 27, 39, 674, DateTimeKind.Local).AddTicks(3404), "Kalem1", 20m, 20, null },
                    { 2, 2, new DateTime(2023, 10, 20, 10, 27, 39, 674, DateTimeKind.Local).AddTicks(3415), "Kitap1", 200m, 30, null },
                    { 3, 2, new DateTime(2023, 10, 20, 10, 27, 39, 674, DateTimeKind.Local).AddTicks(3423), "Kitap2", 600m, 30, null },
                    { 4, 2, new DateTime(2023, 10, 20, 10, 27, 39, 674, DateTimeKind.Local).AddTicks(3424), "kitap3", 320m, 30, null }
                });
